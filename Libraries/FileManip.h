...
namespace FileManip {
	...
	std::wstringstream DataInput (const std::filesystem::path & Path);
	...
	void JoinFiles (const std::vector<std::filesystem::path> & ListOfNames, const std::filesystem::path & PathToDirectory,
